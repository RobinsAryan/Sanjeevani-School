...
const myRoomUrl = window.location.origin + '/join/' + roomId;
...
/**
 * Configuration for controlling the visibility of buttons in the Sanjeevani School client.
...
// if false the cam-Off avatar = images.avatar
...
async function whoAreYou() {
    ...
    Swal.fire({
        ...
        allowEscapeKey: false,
        background: swBg,
        title: 'Sanjeevani School',
        position: 'center',
        input: 'text',
        inputPlaceholder: 'Enter your name',
        inputAttributes: { maxlength: 32 },
        inputValue: myStudentName,
        inputDisabled: true,
...
function setPeerAvatarImgName(videoAvatarImageId, peerName) {
    ...
    if (useAvatarSvg) {
        ...
        videoAvatarImageElement.setAttribute('src', UserProfile);
    }
}
...
function setPeerChatAvatarImgName(avatar, peerName) {
    ...
    switch (avatar) {
        ...
        case 'right': {
            ...
            else rightChatAvatar = UserProfile;
            break;
        }
    }
}
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            Email:<a 
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject=Sanjeevani School info"> 
